<template>
    <div>
        ...
        <div id="messageArea">
          <ul class="ChatLog">
              <li class="ChatLog__entry" v-for="message in messages" :class="{'ChatLog__entry_mine': message.isMine}">
                  <img class="ChatLog__avatar" src="/qnabot/public/logo.png" />
        ...
        <input type="text" class="ChatInput" @keyup.enter="sendMessage" v-model="newMessage" placeholder="Enter Text Here">
    </div>
</template>
